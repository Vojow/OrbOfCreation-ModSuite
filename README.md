...
|---|---|---|
| **Orb Automata 0.8.3** | Beta | Rejection-aware, completion-responsive queue-filling Auto Buy; coordinated Auto Cast; timed or catch-up Concept rotation; and progression-aware spell leveling with verified native mutation postconditions. |
...
| **Orb Mentor 0.3.3** | Beta | Progression-gated spell, artifact, and ordinary-alchemy mastery sharing with verified XP deltas, independent opt-in domains, equipped-spell sources, and a selectable highest-only spell policy. |
