...
|---|---|---|
| **Orb Automata 0.4.0** | Beta | Auto Buy and Auto Cast with affordability, reserves, and queue ownership. |
...
| **Orb Mentor** | Planned | Highest-mastery spells mentor lower-level discovered spells. |
