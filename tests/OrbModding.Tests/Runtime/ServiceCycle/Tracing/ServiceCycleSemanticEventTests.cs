    ...
    public void DirectConstructionRejectsWrongCodeDomainsAndNativeEvidence()
    {
        var invalid = new[]
        {
            ...
            (ServiceCycleSemanticEventKind.CaptureCompleted,
                ServiceCycleSemanticPayload.CaptureFact(in ServiceCycleTraceFixtures.Capture, 4, 3, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionCommitted,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 1, 2, NativeMutationOutcome.Verified, 1, 1, 1, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionCommitted,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 1, 1, NativeMutationOutcome.Verified, 1, 1, 0, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionRejected,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 2, 1, null, 0, 0, 0, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionFaulted,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 3, 5, NativeMutationOutcome.ExecutionThrew, 1, 1, 0, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionFaulted,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 3, 7, NativeMutationOutcome.Verified, 1, 1, 1, 100, 0)),
            (ServiceCycleSemanticEventKind.ActionFaulted,
                ServiceCycleSemanticPayload.ActionFact(in ServiceCycleTraceFixtures.Cycle, 8, 10, 0, 3, 7, NativeMutationOutcome.ExecutionThrew, 1, 0, 0, 100, 0)),
