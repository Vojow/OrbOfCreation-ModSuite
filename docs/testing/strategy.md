...
native multi-buy safety contracts. `AutoConceptReliability` selects the trace-derived
receipt, settlement, rejection-backoff, depth, and timed-rotation journeys.
