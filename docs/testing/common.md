...
| ServiceCycle rolling action outcomes | [ServiceActionOutcomeWindowProjectionTests.cs](../../tests/OrbModding.Tests/Runtime/ServiceCycle/Observation/Journal/ServiceActionOutcomeWindowProjectionTests.cs), [ServiceActionTimelineProjectionTests.cs](../../tests/OrbModding.Tests/Runtime/ServiceCycle/Observation/Journal/ServiceActionTimelineProjectionTests.cs) | every registered service, future health projectors, and the Mod Config committed-work timeline |
