...
| Auto Items and Auto Scribe | [Auto Items and Auto Scribe](automata/auto-items-scribe.md) | `FullyQualifiedName~AutoItems|FullyQualifiedName~AutoScribe|FullyQualifiedName~ScrollCoveragePlanner` |
