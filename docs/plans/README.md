...
| [Auto Scribe](auto-scribe.md) | Runtime fix ready | First-launch type-safety and Mods-rail defects are fixed with regression coverage; rebuilt DLL installation and fresh-launch validation remain. |
