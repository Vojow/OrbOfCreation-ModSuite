...
| [Auto Buy rejection-aware scheduler](autobuy-rejection-index.md) | Foundation implemented / desktop stress gate passed | Typed rejection evidence and queue-filling prepared groups are portable- and game-tested; threshold-indexed wakeups and Steam Deck profiling remain. |
