...
These changes reduce immediate pressure but do not yet provide shared scheduling, lifecycle-aware candidate indexing, dirty updates, resource snapshots, or bounded purchase prediction.
