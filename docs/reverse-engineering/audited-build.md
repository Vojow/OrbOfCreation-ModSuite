...
[`data/native-contracts.json`](../../data/native-contracts.json) is the reviewable inventory of
...
5. Re-import [`data/entity-mappings.tsv`](../../data/entity-mappings.tsv) if assets were added or
