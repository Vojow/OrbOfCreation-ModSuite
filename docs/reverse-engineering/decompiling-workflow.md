...
| [`data/entity-*.tsv`](https://github.com/Vojow/OrbOfCreation-ModSuite/blob/main/data/README.md) + `tools/find-entity.py` | UUID ↔ managed type ↔ internal name ↔ display name | relationships, state |
