...
Eight services are composed today — world collection, Auto Harvest, Auto Items, Auto Buy, Spell
Leveling, Auto Cast, Auto Concept, and Mentor — each through an explicit typed registration, and
