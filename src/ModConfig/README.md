...
- Groups the suite into live Runtime and Chronicle Runs pages plus General, seven automation feature pages, and Advanced while preserving the original section/key contract. Runs includes paged, archetype-filtered time-rune level transitions and current/PB Tempo:Scaling:Investment ratios.
