...
drives world collection, Auto Items, Auto Scribe, Auto Harvest, Auto Buy, Spell Leveling, Auto Cast,
Auto Concept, and Mentor. The ordinary runner through semantic export, snapshot export, and schema-v7
