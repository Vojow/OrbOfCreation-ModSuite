...
public static class PluginIds
{
    ...
    public const string AchievementResonanceGuid = "dev.vojow.orbofcreation.achievementresonance";
    public const string AchievementResonanceName = "Orb Achievement Resonance";

    public const string AutomataGuid = "dev.vojow.orbofcreation.automata";
    public const string AutomataName = "Orb Automata";
    public const string AutomataVersion = "0.5.2";
