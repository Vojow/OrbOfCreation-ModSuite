...
internal sealed class ServiceRunnerPosition<TFrame, TConfig, TState, TAction>
    where TConfig : notnull
{
    private ServiceRunner<TFrame, TConfig, TState, TAction>? _runner;

    internal ServiceRunnerPosition(int index) => Index = index;

    internal int Index { get; }
    internal ServiceRunnerPositionState State { get; private set; }
    internal ServiceRunner<TFrame, TConfig, TState, TAction>? Runner => _runner;
    ...
    internal void InstallCurrent(ServiceRunner<TFrame, TConfig, TState, TAction> runner)
    {
