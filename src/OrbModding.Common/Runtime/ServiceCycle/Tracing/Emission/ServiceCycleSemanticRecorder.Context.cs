...
{
    public void ConfigurationPublished(
        int ordinal,
        ConfigGeneration generation,
        MonotonicTimestamp observedAt) =>
        _context.ConfigurationPublished(ordinal, generation, observedAt);

    public void StrategyPublished(
        int ordinal,
        StrategyGeneration generation,
        MonotonicTimestamp observedAt) =>
        _context.StrategyPublished(ordinal, generation, observedAt);
