...
public readonly partial struct ServiceCycleSemanticPayload
{
    internal static ServiceCycleSemanticPayload Publication(
        ...
        new(
            strategy
                ? ServiceCycleSemanticFields.Service | ServiceCycleSemanticFields.Strategy | ServiceCycleSemanticFields.Timestamp
                : ServiceCycleSemanticFields.Service | ServiceCycleSemanticFields.Configuration | ServiceCycleSemanticFields.Timestamp,
            service.Value, 0, strategy ? 0 : generation, strategy ? generation : 0, 0, 0, 0, 0, 0,
