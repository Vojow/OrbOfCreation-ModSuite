    ...
    where TConfig : notnull
{
    ...
    private readonly ServiceCycleWorker<TFrame, TConfig, TState, TAction> _worker;
    private readonly ServiceCycleMainState<TConfig> _main;
    private readonly ServiceCycleStartCoordinator<TFrame, TConfig, TState, TAction> _starts;
    private readonly ServiceBatchResponseHandler<TFrame, TConfig, TState, TAction> _responses;
    private readonly ServiceBatchActionExecutor<TFrame, TConfig, TState, TAction> _actionExecutor;
    private readonly ServiceBatchCompletion<TFrame, TConfig, TState, TAction> _batchCompletion;
    private readonly ServiceRunnerDiagnosticsAssembler<TFrame, TConfig, TState, TAction> _diagnostics;
    ...
    internal ServiceRunner(
        ...
        in ServiceRunnerParts<TFrame, TConfig, TState, TAction> parts)
    {
    ...
    internal ServiceConfigurationPublisher<TConfig> Configuration => _configuration;
    ...
    private void ThrowIfDisposed()
    {
        if (_disposed)
            throw new ObjectDisposedException(
                nameof(ServiceRunner<TFrame, TConfig, TState, TAction>));
    }
}
