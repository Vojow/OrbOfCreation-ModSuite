...
internal sealed class ServiceBatchActionOutcome<TFrame, TConfig, TState, TAction>
    where TConfig : notnull
{
    private readonly ServiceBatchRuntime<TFrame, TConfig, TState, TAction> _runtime;
    private readonly ServiceBatchCompletion<TFrame, TConfig, TState, TAction> _completion;
