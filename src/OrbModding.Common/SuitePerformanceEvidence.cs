...
public static class SuitePerformanceWorkIdentities
{
    ...
    public static SuitePerformanceWorkIdentity GetSupportedSuiteV1(int index) => index switch
    {
        ...
        2 => AutoCastEvaluate,
        3 => AutoCastMutation,
        4 => AutoConceptMutation,
        5 => AutoConceptEvaluate,
        6 => AutoSpellLevelEvaluate,
        7 => AutoSpellLevelMutation,
        8 => MentorMutation,
        9 => MentorEvaluate,
        10 => ModConfigWork,
...
public sealed class SuitePerformanceEvidence
{
    ...
    public const string ProfileSha256 = "08bacd26c5607e33e40da149d3fcd354b77b1085227252f3c862bdc63615db19";
        ...
        SuitePerformanceEvidencePoint start)
    {
        ...
        if (start.Coordinator.SoftBudgetMilliseconds != end.Coordinator.SoftBudgetMilliseconds ||
            start.Coordinator.HardBudgetMilliseconds != end.Coordinator.HardBudgetMilliseconds)
        {
            throw new InvalidOperationException("Coordinator budgets changed during the performance evidence capture.");
        }
