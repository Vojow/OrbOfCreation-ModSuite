...
{
    private AutomataConfiguration _current = null!;
    ...
    private BepInExAutomataConfiguration(
        ...
        BepInExAutomataReplayConfiguration replay,
        ...
        ConfigEntry<float> relativeReserveMultiplier)
    {
        ...
        RefreshCurrent();
        config.SettingChanged += (_, _) => RefreshCurrent();
    }
    ...
    public BepInExAutomataReplayConfiguration Replay { get; }

    public ConfigEntry<string> AbsoluteReserve { get; }

    public ConfigEntry<float> RelativeReserveMultiplier { get; }

    public AutomataConfiguration Current => Volatile.Read(ref _current);
    ...
    private static BepInExAutomataConfiguration BindCurrent(ConfigFile config)
    {
            ...
            var result = new BepInExAutomataConfiguration(
                ...
                BepInExAutomataReplayConfiguration.Bind(config),
