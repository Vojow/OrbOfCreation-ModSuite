...
{
    internal static AutomataConfiguration Read(BepInExAutomataConfiguration source)
    {
        if (source is null) throw new ArgumentNullException(nameof(source));

        return new AutomataConfiguration
        {
            General = new AutomataGeneralConfiguration
            {
            ...
            Safety = new AutomataSafetyConfiguration
            {
                EmergencyDisable = source.EmergencyDisable.Value,
            },
            Performance = new AutomataPerformanceConfiguration
            {
                CpuBudgetMilliseconds = source.CpuBudgetMilliseconds.Value,
            },
            Diagnostics = new AutomataDiagnosticsConfiguration
            {
            ...
            Replay = new AutomataReplayConfiguration
            {
                EnableAutoHarvestCapture = source.Replay.EnableAutoHarvestCapture.Value,
            },
