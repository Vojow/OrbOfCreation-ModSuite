        ...
        out AutoHarvestNativeFailure failure)
    {
        ...
        try
        {
            ...
            current = new AutoHarvestPairBinding(
                ...
                actionResolution,
                rewardResolution,
                specification.ExpectedGrowthSeconds,
                specification.ExpectedRestSeconds,
                specification.ExpectedActionSeconds);
            current.ActionSafety = _contractAuditor.ReadActionSafety(
                _contract!,
                _shared,
                current);
