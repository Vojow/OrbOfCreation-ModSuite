...
internal sealed class AutoHarvestSharedBinding
{
    ...
    public object CompletionScalingWeight { get; }
...
internal sealed class AutoHarvestPairBinding
{
    ...
    public AutoHarvestActionSafetyState ActionSafety { get; set; }
