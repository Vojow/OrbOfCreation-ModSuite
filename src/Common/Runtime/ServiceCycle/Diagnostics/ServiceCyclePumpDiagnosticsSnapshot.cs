...
public readonly struct ServiceCyclePumpDiagnosticsSnapshot
{
    internal ServiceCyclePumpDiagnosticsSnapshot(in SuiteFramePumpCumulativeSnapshot source)
    {
        ...
        WorldGateDeferrals = source.WorldGateDeferrals;
    ...
    /// <summary>How many service starts the world freshness gate has held closed in total.</summary>
    public long WorldGateDeferrals { get; }
