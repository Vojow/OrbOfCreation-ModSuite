...
{
    public const ushort SchemaVersion = 7;
    public const int HeaderBytes = 64;
    public const int RecordBytes = ServiceCycleSemanticEventV7Codec.RecordBytes;
        ...
        int maximumRecords = DefaultMaximumRecords)
    {
        ...
        {
            events[i] = ServiceCycleSemanticEventV7Codec.Read(
