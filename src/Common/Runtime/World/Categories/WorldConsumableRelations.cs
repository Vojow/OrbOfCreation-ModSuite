...
/// <summary>Which native cost vector a consumable row came from.</summary>
internal enum WorldConsumableCostKind
{
    /// <summary>Paid once when the item is accepted for use.</summary>
    Consume = 0,

    /// <summary>Held for the lifetime of a duration item.</summary>
    Usage = 1,
}

/// <summary>One resource entry in a consumable's immediate or held cost vector.</summary>
...
/// <summary>
/// Reads consumable scalars together with their native family and cost relations. Keeping the three
/// buffers under one traversal makes an incomplete relation an incomplete consumable category
/// instead of publishing a scalar row that looks safe to automate.
/// </summary>
