        ...
        return new GameWorldState
        {
            ...
            ScribeWork = WorldScribeRelationDeriver.Build(
                ...
                static (left, right) =>
                {
                    ...
                    return queue != 0 ? queue : left.RecipeId.CompareTo(right.RecipeId);
                }),
            ...
            ScrollTargets = WorldScribeRelationDeriver.Build(
                ...
                static (left, right) =>
                {
                    var consumable = left.ConsumableId.CompareTo(right.ConsumableId);
                    if (consumable != 0) return consumable;
