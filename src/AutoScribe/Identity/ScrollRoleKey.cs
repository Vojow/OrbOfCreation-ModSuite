    ...
    IComparable<ScrollRoleKey>
{
    ...
    public override bool Equals(object? obj) => obj is ScrollRoleKey other && Equals(other);
    public override int GetHashCode() => StringComparer.Ordinal.GetHashCode(Value ?? string.Empty);
    public override string ToString() => Value ?? string.Empty;
    public static bool operator ==(ScrollRoleKey left, ScrollRoleKey right) => left.Equals(right);
    public static bool operator !=(ScrollRoleKey left, ScrollRoleKey right) => !left.Equals(right);
}
